...
public class LeftPlayer implements RemovingTypes {
    private final Player player;
    private final LinkedList<Player> members;

    public LeftPlayer(Player player, LinkedList<Player> list_of_players) {
        this.player = player;
    ...
    public void execute(Party party, PartyManager manager) {
        ...
        // call event
        Event event = new PlayerLeavePartyEvent(this.player, party);
